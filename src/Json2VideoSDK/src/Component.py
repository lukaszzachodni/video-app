...
class Component:
    """
    A class representing the component element schema for the JSON2Video API.
    """
    ...
    def __init__(
        ...
        Args:
            component (str): ID of the Component element.
            type (str): Type of the element. Defaults to "component".
            ...
            settings (Dict): Settings to be passed to the component. Defaults to None.
    ...
    def to_dict(self) -> Dict:
        """Returns a dictionary representing the Component object."""
        return {
